...
const required = [
  ...
  ['easy pack has tuple lesson', pack, 'Tuple: dữ liệu cềEđịnh'],
  ['easy pack has dict lesson', pack, 'map key ↁEvalue'],
  ['easy pack has fastapi lesson', pack, 'route mỏng, schema rõ, service dềEtest'],
  ['easy pack has project lesson', pack, 'README và test'],
  ['lesson page renders V101', panel, 'V101R Bài học dềEhiểu'],
  ['lesson page has explanation blocks', panel, 'Giải thích từng ý'],
  ['lesson page has code and trace', panel, 'Code mẫu thật đềEđọc'],
