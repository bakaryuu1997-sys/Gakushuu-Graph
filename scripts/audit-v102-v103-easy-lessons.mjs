...
const required = [
  ...
  ['FE pack has security lesson', files.fePack, 'threat ↁEimpact ↁEcountermeasure'],
  ['AI pack has ML lesson', files.aiPack, 'data ↁEmodel ↁEprediction ↁEevaluation'],
  ['AI pack has GenAI lesson', files.aiPack, 'prompt ↁEcontext ↁEoutput ↁEkiểm chứng'],
  ['AI pack has ethics lesson', files.aiPack, 'quyền riêng tư, công bằng và trách nhiệm'],
  ['AI pack has business lesson', files.aiPack, 'vấn đềEkinh doanh, dữ liệu và hiệu quả'],
