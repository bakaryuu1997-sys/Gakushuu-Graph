...
const checks = [
  ...
  { name: 'fundamental_start_route', pass: workspaceSource.includes('FundamentalInfoFocusMode') && workspaceSource.includes('activeView === "start" && props.courseTitle.includes("åŸºæœ¬æƒE ±")'), value: 'LessonWorkspace' },
  { name: 'fundamental_session_route', pass: workspaceSource.includes('FundamentalInfoExamSimulator') && workspaceSource.includes('activeView === "session" && props.courseTitle.includes("åŸºæœ¬æƒE ±")'), value: 'LessonWorkspace' },
  { name: 'fundamental_practice_route', pass: workspaceSource.includes('FundamentalInfoPracticeDrills') && workspaceSource.includes('activeView === "practice" && props.courseTitle.includes("åŸºæœ¬æƒE ±")'), value: 'LessonWorkspace' },
