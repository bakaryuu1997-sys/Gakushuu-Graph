...
const required = [
  ...
  ['Frontend has written explanation', files.pack, 'biến thiết kế thành giao diện dềEdùng'],
  ['Linux has written explanation', files.pack, 'hiểu terminal bằng thao tác an toàn'],
  ['BrSE has written explanation', files.pack, 'biến trao đổi mơ hềEthành thông tin triển khai được'],
