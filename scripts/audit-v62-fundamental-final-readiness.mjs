...
const checks = [
  ...
  { name: 'japanese_scenarios_expanded', pass: countKind('japanese-scenario') >= 12 && scenarioText.includes('最も適刁E) && scenarioText.includes('誤ってぁE��') && scenarioText.includes('以丁E), value: String(countKind('japanese-scenario')) },
  { name: 'long_trace_scenarios_expanded', pass: countKind('long-trace') >= 6 && scenarioText.includes('再帰呼出ぁE) && scenarioText.includes('挿入ソーチE), value: String(countKind('long-trace')) },
