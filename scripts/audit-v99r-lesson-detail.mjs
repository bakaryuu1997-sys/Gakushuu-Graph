...
const checks = [
  ...
  ['lesson detail exercise block', files.detail, '4. Bài tập nhềE],
  ['lesson detail expected output', files.detail, 'Expected output / test case'],
  ['lesson detail mini quiz', files.detail, '5. Quiz nhềE],
  ['lesson panel renders V99 detail', files.panel, 'V99LessonDetailPage'],
  ['blueprint has Python FastAPI content', files.blueprint, 'FastAPI route mỏng + service dềEtest'],
