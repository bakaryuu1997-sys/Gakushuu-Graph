...
export function FundamentalInfoLessonSection({ node, lesson, language }: Props) {
  ...
  return (
    <section className="space-y-6" aria-label="Fundamental Info Custom Lesson Section">
      {/* 1. Khái niệm cốt lõi */}
      <div className="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-gradient-to-br from-blue-50/50 via-white to-white p-6 shadow-sm dark:border-slate-800 dark:from-slate-900/50 dark:via-slate-950 dark:to-slate-950">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl bg-blue-100 p-2.5 text-blue-700 dark:bg-blue-950/50 dark:text-blue-400">
            <BookOpen className="h-5 w-5" />
          </div>
          <h3 className="text-sm font-black uppercase tracking-[.15em] text-blue-700 dark:text-blue-400">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Vì sao quan trọng */}
        <div className="rounded-[2rem] border border-blue-100/70 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-blue-50 p-2.5 text-blue-700 dark:bg-blue-950/40 dark:text-blue-400">
