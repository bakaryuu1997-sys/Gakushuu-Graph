...
export function AiPassportLessonSection({ node, lesson, language }: Props) {
  ...
  return (
    <section className="space-y-6" aria-label="AI Passport Custom Lesson Section">
      {/* 1. Khái niệm cốt lõi */}
      <div className="relative overflow-hidden rounded-[2rem] border border-violet-100 bg-gradient-to-br from-violet-50/50 via-white to-white p-6 shadow-sm dark:border-slate-800 dark:from-slate-900/50 dark:via-slate-950 dark:to-slate-950">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl bg-violet-100 p-2.5 text-violet-700 dark:bg-violet-950/50 dark:text-violet-400">
            <BookOpen className="h-5 w-5" />
          </div>
          <h3 className="text-sm font-black uppercase tracking-[.15em] text-violet-700 dark:text-violet-400">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Vì sao quan trọng */}
        <div className="rounded-[2rem] border border-indigo-100 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-indigo-100 p-2.5 text-indigo-700 dark:bg-indigo-950/50 dark:text-indigo-400">
              <ShieldCheck className="h-5 w-5" />
            </div>
            <h3 className="text-sm font-black uppercase tracking-[.15em] text-indigo-700 dark:text-indigo-400">
